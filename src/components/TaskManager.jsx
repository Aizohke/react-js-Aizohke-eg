...
/**
 * TaskManager component with localStorage persistence.
 * I kept your local hook logic but named the file/exports consistently.
 */
...
const TaskManager = () => {
  const { tasks, addTask, toggleTask, deleteTask, setTasks } = useLocalStorageTasks();
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div className="flex gap-2 mb-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          <Button variant="secondary" size="sm" onClick={() => setTasks([])}>
            Clear All
          </Button>
        </div>
      </div>
